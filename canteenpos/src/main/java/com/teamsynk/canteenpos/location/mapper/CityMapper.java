...
public class CityMapper {
	...
	public static CityResponseDto toDto(City city) {
		...
		return new CityResponseDto(
				...
				city.getDistrict().getState().getId(),
				city.getDistrict().getState().getStateName(),
				city.getDistrict().getState().getCountry().getId(),
				city.getDistrict().getState().getCountry().getCountryName(),
				city.getIsActive(),
				city.getCreatedDt(),
				city.getModifiedDt(),
				city.getCreatedBy(),
